        ...
        <header className="w-full bg-white border-b border-gray-200 fixed top-0 left-0 z-30">
            <nav className="max-w-7xl mx-auto flex items-center justify-between px-8 py-7">
                ...
                <div className="hidden md:flex items-center gap-8">
                    ...
                    {/* Auth Button */}
                    <button className="ml-8 px-6 py-2 border border-black rounded-full bg-white text-black font-serif text-lg font-medium hover:bg-black hover:text-white transition-all duration-200">
                        Login
                    </button>
                </div>
...
const MobileMenu = ({ navItems }) => {
    ...
    return (
        <>
            ...
            {/* Mobile Dropdown */}
            <div className={`absolute left-0 top-full w-full bg-white border-b border-gray-200 shadow transition-all duration-300 overflow-hidden z-20 ${open ? "max-h-[320px] opacity-100" : "max-h-0 opacity-0 pointer-events-none"}`}>
                <ul className="flex flex-col gap-2 p-6 font-serif">
                    ...
                    <li className="pt-2">
                        <button className="w-full px-6 py-2 border border-black rounded-full bg-white text-black font-serif text-lg font-medium hover:bg-black hover:text-white transition-all duration-200">
                            Login
                        </button>
                    </li>
                </ul>
